...
python3 training_data_generation.py --task t1 --config blocksworld_large --ignore_existing [--specific_instances SPECIFIC-INSTANCES] [--random_example RANDOM-EXAMPLE] [--verbose VERBOSE] [--seed SEED]
```
